...
- **Resizable Game Board (August 10, 2025)**: Added comprehensive board resizing functionality allowing all users to adjust board dimensions. Features include: preset size options (Small 600×400 to Huge 1600×1200), custom size input with validation (200-3000 pixels), real-time board dimension updates, scrollable board containers for larger boards, and universal access for both GMs and players. Board size controls are always visible in the top-right corner.
